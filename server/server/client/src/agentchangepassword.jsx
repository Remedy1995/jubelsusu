...
function AgentChangePassword(){
    ...
    fetch(`agentchangepassword/agentchangepassword${id}`, requestOptions)
	.then(res=>{
		if(res.status===200){
...
return(
 ...
 <Header/><button type="button" className="navbar-toggle" data-toggle="collapse" data-target="#collapseExample"  onClick={OpenSidebar} >
       ...
       <div className="content-main" style={{background:"white"}}>
            ...
            <div className="panel-body">
				...
				<button className="btn-primary btn" value="Change Agent Password" >Change Agent Password</button>
					</form>
	</div>
