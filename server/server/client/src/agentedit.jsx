...
function AgentEditDetails(){
    ...
    if(usern.length<1||first.length<1||acc.length<1||dat.length<1||addre.length<1||occu.length<1){
    ...
    const inputlastname=last.lastname;
     ...
     const inputaddress=addr.address;

	 
	 const {occupation} = e.target.elements
     const occup= {occupation:occupation.value};
     const inputoccupation=occup.occupation;
    ...
    fetch(`agentedit/agentedit${id}`, requestOptions)
    .then(response => response.text())
    .then(result => console.log(result))
    .catch(error => console.log('error', error));
    
    e.target.reset();
	swal("Successful!", "You have successfully edited your information!", "success");
 }
						...
						<div className="form-group">
							...
							<div className="col-md-8">
								<div className="input-group input-icon right">
									...
									<input type="text"  className="form-control1"  id="address" placeholder="address" onChange={addressHandler} />
								</div>
						...
						<div className="form-group">
							...
							<div className="col-md-8">
								<div className="input-group input-icon right">
									...
									<input type="text"  className="form-control1"  id="occupation" placeholder="occupation" onChange={occupationHandler} />
								</div>
...
export default AgentEditDetails;